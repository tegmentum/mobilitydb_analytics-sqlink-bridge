...
const PROVIDER_ID: &str = "mobilitydb_analytics-composed";
...
fn scalar_name_by_id(id: u64) -> Option<&'static str> {
    match id {
        1 => Some("angular_diff"),
        2 => Some("average_frechet_distance"),
        3 => Some("bearing"),
        4 => Some("distance"),
        5 => Some("dtw_distance"),
        6 => Some("dtw_distance_normalized"),
        7 => Some("edr_distance"),
        8 => Some("frechet_distance"),
        9 => Some("hausdorff_distance"),
        10 => Some("lcss_distance"),
        11 => Some("lcss_similarity"),
        12 => Some("twed_distance"),
        13 => Some("twed_distance_normalized"),
        _ => None,
    }
}
...
impl MetadataGuest for Component {
    fn describe() -> Manifest {
        let scalar_functions: Vec<ScalarFunctionSpec> = vec![
            ScalarFunctionSpec {
                id: 1,
                name: "angular_diff".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 2,
                name: "average_frechet_distance".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
            ...
            ScalarFunctionSpec {
                id: 5,
                name: "dtw_distance".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 6,
                name: "dtw_distance_normalized".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 7,
                name: "edr_distance".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 8,
                name: "frechet_distance".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 9,
                name: "hausdorff_distance".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 10,
                name: "lcss_distance".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 11,
                name: "lcss_similarity".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 12,
                name: "twed_distance".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 13,
                name: "twed_distance_normalized".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
        ];
